      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3.5px] top-[34.5px] z-50 sm:right-[3.5px] sm:top-[3.5px] md:right-[3.5px] md:top-[4.5px]">
              <Button
                type="small"
        ...
        <div>
          ...
          {/* we use this hack because we cannot get data from redux inside a action function */}
...
export async function action({ request }) {
  ...
  // This is a hack because we cannot access useDispatch inside action function
  // Do not overuse since this will affect performance improvements provided by Redux
